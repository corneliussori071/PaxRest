...
export default function CartPage() {
  const { items, orderType, deliveryFee, customerName, customerPhone, notes, subtotal, total, itemCount, setOrderType, setCustomerName, setCustomerPhone, setNotes, updateQuantity, removeItem, setDeliveryAddress } = useCartStore();
        ...
        <Grid size={{ xs: 12, md: 7 }}>
          ...
          <Card sx={{ mt: 2 }}>
            <CardContent>
              ...
              {orderType === 'delivery' && (
                <TextField
                  fullWidth label="Delivery Address" size="small" sx={{ mb: 2 }}
                  value={address}
                  onChange={(e) => {
